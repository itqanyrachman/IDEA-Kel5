...
<body>
      ...
      <div class="row g-0 align-items-center">
        <div class="col-lg-6 mb-5 mb-lg-0">
          <div class="card cascading-right"
            style="background: hsla(0, 0%, 100%, 0.55); backdrop-filter: blur(30px); border-radius:20px;">
            ...
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
              ...
              <form action="daftar_act.php" method="post">
                ...
                <label class="form-label" for="">Nomor HP / Whatsapp </label>
                  <input type="number" class="form-control" required="required" name="hp"
            ...
            <div class="form-group">
              ...
              <p class="btn btn-link btn-block">Sudah punya akun? <a href="masuk.php"
  ...
  <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js"
    integrity="sha384-KyZXEAg3QhqLMpG8r+V05bA6PZ8elAvjOzF8g63ZfC+qGz4B+2/nO8DKre0Koeb6"
    crossorigin="anonymous"></script>
  <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.9.1/dist/umd/popper.min.js"
    integrity="sha384-jeEuY/zsF6/DI0Kcr6f7f2E1dfH1oCnwtzf3oXZcDhIpN4qGBjckWNABynVccuCi"
    crossorigin="anonymous"></script>
  <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"
    integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6p0m5h5+Y9J6Bk2n0gBImB8I1fo4J6hDh"
    crossorigin="anonymous"></script>
