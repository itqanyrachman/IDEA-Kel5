                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-danger btn-sm fa fa-trash" href="member_hapus_komentar.php?id=<?php echo $d['diskusi_id']; ?>" onClick="return confirm('Apakah Anda yakin untuk menghapus komentar ini?')"></a>
                                    </td>
                                </tr>
